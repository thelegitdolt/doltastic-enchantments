...
public class CreativeEventsMixin {
    @WrapWithCondition(method = "build", at = @At(value = "INVOKE", target = "Lnet/neoforged/neoforge/event/BuildCreativeModeTabContentsEvent;accept(Lnet/minecraft/world/item/ItemStack;)V"))
    private static boolean DoltasticEnchantments$HideReliablyRemovedBooks(BuildCreativeModeTabContentsEvent instance, ItemStack stack) {
        ...
        if (DEReliableRemoverCompat.isEnchantmentRemoved(enchant)) return false;
        return true;
    }
}
