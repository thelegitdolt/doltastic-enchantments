...
public class DEItems {
    public static final ItemSubRegistryHelper ITEMS = DoltasticEnchantments.REGISTRY_HELPER.getItemSubHelper();

    public static final DeferredItem<Item> FAIRY_DUST = ITEMS.createItem("fairy_dust", () -> new Item(new Item.Properties()));
